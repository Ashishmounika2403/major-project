                        ...
                        <div class="navbar-collapse collapse">							
                            <div class="menu">
                                <ul class="nav nav-tabs" role="tablist">
                                    ...
                                    <li role="presentation"><a href="stud_reg.jsp" class="active">Student Register</a></li>
                ...
                <div class="text-center">
                    <div class="services-box">
                        <div class="wow bounceInDown" data-wow-offset="0" data-wow-delay="0.3s">
                            <h2 style="font-size: 50px">Student Registration</h2>					
                        </div>
                        <style>
                            input[type=text], select,input[type=email],input[type=date],input[type=password] ,input[type=date] {
                                width: 40%;
                                padding: 12px 20px;
                                margin: 8px 0;
                                color: black;
                        ...
                        <form action="stud_regcode.jsp" method="get">
                            ...
                            <select id="country" name="college">
                            ...
                            <input style="height: 45px" type="date" id="fname" name="date" placeholder="Data OF Birth">
