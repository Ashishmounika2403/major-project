                        ...
                        <div class="navbar-collapse collapse">							
                            <div class="menu">
                                <ul class="nav nav-tabs" role="tablist">
                                    <li role="presentation"><a href="verification.jsp">Back</a></li>						
                ...
                <div class="text-center">
                    <div class="services-box">
                        ...
                        <div class="wow bounceInDown" data-wow-offset="0" data-wow-delay="0.3s">
                            <h2 style="font-size: 35px">File Download Here!!</h2>					
                        </div>
                        <br><br>
                        <center><table>
                                ...
                                <tr>
                                    ...
                                    <th style="color: #080808">Download</th>

                                </tr>

                                <%
                                    String id = (String) session.getAttribute("sssid");
                                ...
                                <tr>
                                    ...
                                    <td style="color: #080808"><a style="color: red" href="Downloads?id=<%=rs.getString("id")%>">click</a></td>
                                </tr>
