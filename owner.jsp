                        ...
                        <div class="navbar-collapse collapse">							
                            <div class="menu">
                                <ul class="nav nav-tabs" role="tablist">
                                    ...
                                    <li role="presentation"><a href="owner.jsp" class="active">Owner</a></li>
                ...
                <div class="text-center">
                    <div class="services-box">
                        <div class="wow bounceInDown" data-wow-offset="0" data-wow-delay="0.3s">
                            <h2 style="font-size: 35px; font-family: cursive"></h2><br>					
                        </div>
                        <style>
                            .container {
                                padding: 16px;
                        ...
                        <div>
                            <div style="width: 50%; float: right">
                                <center><br><img style="width: 400px; height: 300px" src="img/data owner login.jpg"> </center>
                            </div>

                            <div style="width: 50%; float: left">
                                <left><h3 style="font-family: cursive">OWNER LOGIN PAGE</h3></left>
