                        ...
                        <div class="navbar-collapse collapse">							
                            <div class="menu">
                                <ul class="nav nav-tabs" role="tablist">
                                    ...
                                    <li role="presentation"><a href="view_cloud_files.jsp">View Files</a></li>
                                    <li role="presentation"><a href="view_user_request.jsp" class="active">View User Request</a></li>																
                ...
                <div class="text-center">
                    <div class="services-box">
                        ...
                        <div class="wow bounceInDown" data-wow-offset="0" data-wow-delay="0.3s">
                            <h2 style="font-size: 35px">User Request</h2>					
                        </div>
                        <br><br>
                        <center><table>
                                ...
                                <tr>
                                    ...
                                    <th style="color: #080808">Req Status</th>
                                ...
                                <tr>
                                    ...
                                    <td style="color: #080808"><%=rs.getString("username")%></td>
                                    <td style="color: #080808"><%=rs.getString("country")%></td>
                                    <td style="color: #080808"><%=rs.getString("status")%></td>
                                    <td style="color: #4CAF50"><a style="color: #4CAF50" href="response.jsp?id=<%=rs.getString("id")%>">Accept</a></td>
