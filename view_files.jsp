...
<html lang="en">
    <head>
        ...
        <title>CCP-ABSE: A Ciphertext-Policy Attribute-Based Searchable Encryption Scheme</title>
                        ...
                        <div class="navbar-collapse collapse">							
                            <div class="menu">
                                <ul class="nav nav-tabs" role="tablist">
                                    ...
                                    <li role="presentation"><a href="view_files.jsp" class="active">View Files</a></li>
                    ...
                    <div class="services-box">
                        ...
                        <center><table>
                                ...
                                <tr>
                                    ...
                                    <th style="color: #080808">Request</th>

                                </tr>

                                <%
                                    String id = (String) session.getAttribute("ssiid");
                                ...
                                <tr>
                                    ...
                                    <td style="color: #080808"><a style="color: red" href="request.jsp?id=<%=rs.getString("id")%>">Send</a></td>
